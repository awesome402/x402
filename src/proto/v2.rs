...
/// Version 2 of the awesome402 protocol.
#[derive(Debug, Copy, Clone, Default, PartialEq, Eq)]
pub struct Awesome402Version2;

impl Awesome402Version2 {
    pub const VALUE: u8 = 2;
}

impl From<Awesome402Version2> for u8 {
    fn from(_: Awesome402Version2) -> Self {
        Awesome402Version2::VALUE
    }
}

impl Serialize for Awesome402Version2 {
    fn serialize<S: Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_u8(Self::VALUE)
    }
}

impl<'de> Deserialize<'de> for Awesome402Version2 {
...
impl Display for Awesome402Version2 {
...
pub struct VerifyRequest<TPayload, TRequirements> {
    pub x402_version: Awesome402Version2,
